    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        clients
            .inMemory()
                ...
                .scopes("login-system-composite-service", "product-composite-service", "product.read", "product.write", "role.read", "role.write", "user.read", "user.write", "category.read", "category.write")
                .secret("{noop}secret")
                .resourceIds("login-system-composite-service", "role-core-service", "product-core-service", "user-core-service", "category-core-service", "product-composite-service");
