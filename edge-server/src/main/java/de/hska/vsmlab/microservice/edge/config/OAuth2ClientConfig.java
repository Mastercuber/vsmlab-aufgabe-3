...
public class OAuth2ClientConfig {
    ...
    public OAuth2RestTemplate messagingClientAuthCodeRestTemplate(
            @Qualifier("messagingClientAuthCodeDetails") OAuth2ProtectedResourceDetails resourceDetails, @Qualifier("oauth2ClientContext") OAuth2ClientContext oauth2ClientContext) {
